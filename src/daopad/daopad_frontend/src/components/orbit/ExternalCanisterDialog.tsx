...
export default function ExternalCanisterDialog({ open, onOpenChange, canister, mode, onSaved }) {
  ...
  const handleVerifyCanister = async (canisterId, form) => {
    if (!canisterId) {
                    ...
                    <div className="flex gap-2">
                      ...
                      {isCreateMode && (
                        <Button
                          type="button"
                          variant="outline"
                          onClick={() => handleVerifyCanister(field.value, form)}
